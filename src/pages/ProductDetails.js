...
const ProductDetails = () => {
  ...
  if (!product) {
    return <section className='h-screen flex justify-center items-center'>Lodading...</section>;
  }
      ...
      <div className='container mx-auto'>
        <div className=' flex flex-col lg:flex-row items-center'>
          ...
          <div className='flex-1 text-center lg:text-left'>
            <h1 className='text-[26px] font-medium mb-2 max-w-[420px] mx-auto lg:mx-0'>{title}</h1>
